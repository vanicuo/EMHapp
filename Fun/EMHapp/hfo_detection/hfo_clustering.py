...
class hfo_cluster:
    ...
    def get_hfo_from_multi_fifs(self, ied_time_s, max_oris_hfo_s, max_oris_ied_s,
        ...
        for index, raw_data, raw_data_ied, raw_data_hfo, info, leadfield, \
            ...
            print(info['subject_info']['last_name'] + ': HFO_Detection', str(index + 1) + '/' + str(len(ied_time_s)))
            if len(ied_time) == 0:
                continue
...
if __name__ == "__main__":
    ...
    matFile = '/data2/cuiwei/HFO_Detection_Results/MaxOri/ZLH/zhaolihong/@rawzhaolihong10_tsss/SaveHFODetectionResults.mat,' \
              '/data2/cuiwei/HFO_Detection_Results/MaxOri/ZLH/zhaolihong/@rawzhaolihong11_tsss/SaveHFODetectionResults.mat,' \
              '/data2/cuiwei/HFO_Detection_Results/MaxOri/ZLH/zhaolihong/@rawzhaolihong13_tsss/SaveHFODetectionResults.mat'
