...
class cal_peak_feature:
    ...
    def cal_signal_peaks(self, smooth_windows=0.02, smooth_iterations=2, segments_gpu=(0, 0.25, 0.5, 1.1)):
        ...
        try:
            ...
            half_edge_matrix_temp = torch.ones(peak_diff.shape[0] * max_edge_duration).to(self.device)
...
if __name__ == "__main__":
    ...
    raw = mne.io.read_raw_fif('/data2/cuiwei/HFO/LZC/MNE/lizhaocai1_tsss.fif', verbose='error', preload=True)
